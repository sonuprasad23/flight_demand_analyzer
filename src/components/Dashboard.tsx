...
export function Dashboard({ isLoading, error, data, filters, hasSearched }: DashboardProps) {
  ...
  return (
    <div className="h-96 flex flex-col items-center justify-center text-center bg-card/50 rounded-lg border border-border">
        ...
        <p className="text-muted-foreground max-w-md">
          Use the sidebar to select a route and date, then hit "Analyze Demand" to begin.
        </p>
    </div>
  );
}